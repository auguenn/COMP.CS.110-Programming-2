 ...
 * -----------------
 * Luokka, joka edustaa yliopistoa opiskelijoineen, henkilökuntineen sekä kursseineen.
 *
 *
 * -----------------
 * Nimi: Enna Augustin
 ...
 *
 * Huomio: Kohdat, joissa on englanninkielinen kommentointi ovat valmiista
 * koodipohjasta.
 *
 * */
...
public:
    ...
    /**
     * @brief check_account_exists
     * @param account_number
     * @return tosi, jos annettu käyttäjänumero löytyy
     */
    bool check_account_exists(int account_number) const;


    /**
     * @brief check_course_exists
     * @param course_code
     * @return tosi, jos annettu kurssikoodi löytyy
     */
    bool check_course_exists(std::string course_code) const;
